    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        return Scaffold(
          ...
          body: Obx(() => _pages[Utility.btmNavBarController.selectedTab.value]),
          bottomNavigationBar: Obx(() => Container(
            decoration: const BoxDecoration(
                border: Border(
                    top: BorderSide(
                        color: ColorValues.grey2Color, width: 1))),
                ...
                items: [
                  BottomNavigationBarItem(
                      icon: Icon(Icons.movie_filter_outlined,
                        size:24,
                        color: (Utility.btmNavBarController.selectedTab.value.isEqual(0)) ? ColorValues.mainColor : ColorValues.darkTextColor,),
                      label: "Discover"),
                  BottomNavigationBarItem(
